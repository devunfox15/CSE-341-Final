...
const { orderValidationRules, validate } = require('../middleware/orderValidator');
...
router.post('/', isAuthenticated, orderValidationRules(), validate, orderController.createorder);

router.put('/:id', isAuthenticated, orderValidationRules(), validate, orderController.updateorder);
